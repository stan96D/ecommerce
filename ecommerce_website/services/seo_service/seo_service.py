...
class HomeSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "goedkoopste vloeren, pvc vloeren, laminaat, visgraat vloeren, vinyl vloeren, plinten, ondervloeren, Nederland, België, goedkoopste vloerenshop",
            "description": "Goedkoopste vloeren kopen? Bij GoedkoopsteVloerenShop vind je de laagste prijzen voor PVC, laminaat, visgraat, vinyl, plinten en ondervloeren in Nederland en België. Altijd de goedkoopste!"
        }
...
class TermsConditionsSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Lees de algemene voorwaarden van GoedkoopsteVloerenShop voor al onze regels en voorwaarden bij het kopen van vloeren in Nederland en België. Transparant en duidelijk."
        }
...
class DisclaimerSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Lees de disclaimer van GoedkoopsteVloerenShop voor belangrijke juridische informatie over aansprakelijkheid, copyright en gebruiksvoorwaarden bij het kopen van vloeren in Nederland en België."
        }


class PrivacySEOService(SEOServiceInterface):

    @staticmethod
    def get_meta_object(object=None):
        return {
            "title": "Privacy – Goedkoopste Vloeren Shop | Privacy & Cookiebeleid",
            "keywords": "privacy, privacybeleid, persoonsgegevens, gegevensverwerking, cookies, gegevensbescherming, GDPR, persoonsgegevens verwerking, cookies beleid, privacywetgeving, beveiliging van persoonsgegevens, gebruik van cookies",
            "description": "Lees het privacy- en cookiebeleid van GoedkoopsteVloerenShop voor belangrijke informatie over de verwerking van persoonsgegevens, het gebruik van cookies en de bescherming van uw privacy bij het kopen van vloeren in Nederland en België . Wij respecteren uw privacy en zorgen voor een veilige verwerking van uw gegevens."
        }
...
class ContactSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "klantenservice, klantenservice vloeren, contact, vraag, support, snel antwoord, e-mail ondersteuning, vloeren winkel, Nederland, België",
            "description": "Heb je vragen? Onze klantenservice van GoedkoopsteVloerenShop reageert binnen 1 dag via e-mail. Neem contact met ons op voor ondersteuning bij het kopen van vloeren in Nederland en België."
        }
...
class PaymentDeliverySEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "betaling, levering, vloeren levering, betaalmethoden, levering opties, gratis levering, levering Nederland, België, snelle levering",
            "description": "Bij GoedkoopsteVloerenShop bieden we veilige betaalmethoden en snelle leveringsopties. Lees alles over betalingen, leveringstermijnen en bezorginformatie in Nederland en België."
        }
...
class ReturnSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "retourneren, vloeren retourneren, retourvoorwaarden, terugbetaling, retour proces, gemakkelijk retourneren, retourneren Nederland, België",
            "description": "Bij GoedkoopsteVloerenShop kun je vloeren gemakkelijk retourneren. Lees alles over onze retourvoorwaarden, het retourproces en terugbetalingen in Nederland en België."
        }
...
class AboutUsSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "over ons, vloeren winkel, bedrijf, 20 jaar ervaring, goedkope vloeren, beste kwaliteit vloeren, expert team, vloeren Nederland, België, ons verhaal",
            "description": "GoedkoopsteVloerenShop heeft meer dan 20 jaar ervaring in de vloerenbranche. Ons team van 4 experts biedt de goedkoopste vloeren van de beste kwaliteit. Wij leveren PVC, laminaat, visgraat en vinyl vloeren in Nederland en België – simpel maar effectief."
        }
...
class StoreRatingSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "winkelbeoordeling, klantbeoordeling, reviews, vloeren shop beoordelingen, feedback, klantenervaring, klantfeedback, store rating, vloeren Nederland, België",
            "description": "Deel je ervaring bij GoedkoopsteVloerenShop! Laat een beoordeling achter over onze vloeren, service en levering. Lees ook wat andere klanten zeggen over hun aankoopervaring in Nederland en België."
        }
...
class ShoppingCartSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "winkelwagentje, winkelmand, vloeren winkelwagentje, vloeren kopen, bestellingen, vloeren afrekenen, producten toevoegen, winkelmand Nederland, België",
            "description": "Bekijk en bewerk je winkelwagentje bij GoedkoopsteVloerenShop. Voeg vloeren toe, bewerk je bestelling en ga snel door naar het afrekenen van je vloeren in Nederland en België."
        }
...
class CheckoutSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Voltooi je bestelling bij GoedkoopsteVloerenShop. Vul je gegevens in, kies een betaalmethode en voltooi het afrekenproces om de goedkoopste vloeren te kopen in Nederland en België."
        }
...
class PaymentSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Voltooi de betaling van je bestelling bij GoedkoopsteVloerenShop. Kies je gewenste betaalmethode en betaal veilig voor je vloeren in Nederland en België."
        }
...
class OrderDetailSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Bekijk de details van je bestelling bij GoedkoopsteVloerenShop. Volg de status van je vloerenbestelling en bekijk de producten, prijzen en levertijd in Nederland en België."
        }
...
class ReturnDetailSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Bekijk de details van je retour bij GoedkoopsteVloerenShop. Volg de status van je retouraanvraag, bekijk de producten die je hebt geretourneerd en de terugbetaling in Nederland en België."
        }
...
class CreateReturnSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "keywords": "retour aanmaken, vloeren retourneren, retour aanvraag, product retouren, retourproces, retourverzoek, retourneren vloeren, retour Nederland, België",
            "description": "Wil je een product retourneren? Maak eenvoudig een retouraanvraag aan bij GoedkoopsteVloerenShop en volg het retourproces voor vloeren in Nederland en België."
        }
...
class ProductDetailSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        ...
        return {
            ...
            "description": f"{product_description} Bestel nu bij GoedkoopsteVloerenShop voor de goedkoopste prijzen in Nederland en België."
        }
...
class AssortmentSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Bekijk het complete assortiment vloeren bij GoedkoopsteVloerenShop. Van PVC, laminaat en visgraat vloeren tot vinyl, plinten en ondervloeren, altijd de beste prijs in Nederland en België."
        }
...
class FavoritesSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Bekijk je favoriete vloeren bij GoedkoopsteVloerenShop. Van PVC, laminaat, en vinyl tot plinten en ondervloeren, altijd de beste keuze voor vloeren in Nederland en België."
        }
...
class DiscountsSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Bekijk de nieuwste kortingen bij GoedkoopsteVloerenShop! Profiteer van geweldige aanbiedingen op vloeren zoals PVC, laminaat, vinyl, en plinten in Nederland en België."
        }
...
class RunnersSEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        return {
            ...
            "description": "Bekijk ons assortiment hardlopers bij GoedkoopsteVloerenShop. Bescherm je vloeren met de beste kwaliteit runners voor PVC, laminaat, vinyl en andere vloeren in Nederland en België."
        }
...
class CategorySEOService(SEOServiceInterface):
    ...
    def get_meta_object(object=None):
        ...
        return {
            ...
            "description": f"Bekijk het assortiment {category_name} bij GoedkoopsteVloerenShop. {category_description} Van PVC, laminaat, vinyl tot plinten en meer, altijd de beste prijzen in Nederland en België."
        }
